...
public class TestSerialMsg extends net.tinyos.message.Message {
    ...
    public String toString() {
      ...
      try {
        s += "  [counter="+Float.toString(get_counter())+"]\n";
    ...
    /**
     * Return the value (as a float) of the field 'counter'
     */
    public float get_counter() {
        return (float)getFloatElement(offsetBits_counter(), 32);
    }

    /**
     * Set the value of the field 'counter'
     */
    public void set_counter(float value) {
        setFloatElement(offsetBits_counter(), 32, value);
    }
