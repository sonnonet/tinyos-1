 ...
 * This class implements a Java interface to the 'DhvMsg'
 * message type.
 */

public class DhvMsg extends net.tinyos.message.Message {
    ...
    /** Create a new DhvMsg of size 1. */
    public DhvMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new DhvMsg of the given data_length. */
    public DhvMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DhvMsg with the given data_length
     * and base offset.
     */
    public DhvMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DhvMsg using the given byte array
     * as backing store.
     */
    public DhvMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public DhvMsg(byte[] data, int base_offset) {
     ...
     */
    public DhvMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DhvMsg embedded in the given message
     * at the given base offset.
     */
    public DhvMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public DhvMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
