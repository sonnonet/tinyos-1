 ...
 * This class implements a Java interface to the 'DhvDataMsg'
 * message type.
 */

public class DhvDataMsg extends DhvMsg {
    ...
    /** Create a new DhvDataMsg of size 7. */
    public DhvDataMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new DhvDataMsg of the given data_length. */
    public DhvDataMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DhvDataMsg with the given data_length
     * and base offset.
     */
    public DhvDataMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DhvDataMsg using the given byte array
     * as backing store.
     */
    public DhvDataMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public DhvDataMsg(byte[] data, int base_offset) {
     ...
     */
    public DhvDataMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DhvDataMsg embedded in the given message
     * at the given base offset.
     */
    public DhvDataMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public DhvDataMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
