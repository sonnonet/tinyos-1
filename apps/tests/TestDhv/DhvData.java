 ...
 * This class implements a Java interface to the 'DhvData'
 * message type.
 */

public class DhvData extends DhvDataMsg {
    ...
    /** Create a new DhvData of size 16. */
    public DhvData() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new DhvData of the given data_length. */
    public DhvData(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DhvData with the given data_length
     * and base offset.
     */
    public DhvData(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DhvData using the given byte array
     * as backing store.
     */
    public DhvData(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public DhvData(byte[] data, int base_offset) {
     ...
     */
    public DhvData(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DhvData embedded in the given message
     * at the given base offset.
     */
    public DhvData(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public DhvData(net.tinyos.message.Message msg, int base_offset, int data_length) {
