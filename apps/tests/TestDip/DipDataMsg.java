 ...
 * This class implements a Java interface to the 'DipDataMsg'
 * message type.
 */

public class DipDataMsg extends DipMsg {
    ...
    /** Create a new DipDataMsg of the given data_length. */
    public DipDataMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DipDataMsg with the given data_length
     * and base offset.
     */
    public DipDataMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DipDataMsg using the given byte array
     * as backing store.
     */
    public DipDataMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public DipDataMsg(byte[] data, int base_offset) {
     ...
     */
    public DipDataMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DipDataMsg embedded in the given message
     * at the given base offset.
     */
    public DipDataMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public DipDataMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
     ...
     */
    public int get_key() {
        return (int)getUIntBEElement(offsetBits_key(), 16);
    }
    ...
    public void set_key(int value) {
        setUIntBEElement(offsetBits_key(), 16, value);
    }
    ...
    public long get_version() {
        return (long)getUIntBEElement(offsetBits_version(), 32);
    }
    ...
    public void set_version(long value) {
        setUIntBEElement(offsetBits_version(), 32, value);
    }
