 ...
 * This class implements a Java interface to the 'DipData'
 * message type.
 */

public class DipData extends DipDataMsg {
    ...
    /** Create a new DipData of size 16. */
    public DipData() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new DipData of the given data_length. */
    public DipData(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DipData with the given data_length
     * and base offset.
     */
    public DipData(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DipData using the given byte array
     * as backing store.
     */
    public DipData(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public DipData(byte[] data, int base_offset) {
     ...
     */
    public DipData(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DipData embedded in the given message
     * at the given base offset.
     */
    public DipData(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public DipData(net.tinyos.message.Message msg, int base_offset, int data_length) {
