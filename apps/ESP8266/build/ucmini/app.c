...
typedef TMilli UerC__Timer__precision_tag;
...
static void UerC__Boot__booted(void );
# 4 "ESP8266.nc"
static void UerC__ESP8266__initDone(void );
# 83 "/opt/tinyos/tos/lib/timer/Timer.nc"
static void UerC__Timer__fired(void );
#line 83
...
# 2 "ESP8266.nc"
static uint8_t UerC__ESP8266__init(void );
static uint8_t UerC__ESP8266__mode(uint8_t val);
# 11 "UerC.nc"
static inline void UerC__Boot__booted(void );



static inline void UerC__Timer__fired(void );


static inline void UerC__ESP8266__initDone(void );
# 64 "/opt/tinyos/tos/lib/timer/Timer.nc"
...
# 82 "ESP8266P.nc"
enum ESP8266P____nesc_unnamed4320 {
#line 82
  ESP8266P__AT_REV_COMP = 9U
};
#line 82
typedef int ESP8266P____nesc_sillytask_AT_REV_COMP[ESP8266P__AT_REV_COMP];
#line 28
enum ESP8266P____nesc_unnamed4321 {
  ESP8266P__AT_INIT = 0, 
...
enum /*CounterMilli32C.TransformCounterC*/TransformCounterC__2____nesc_unnamed4322 {
...
enum /*TimerMilliP.AlarmMilli32C.TransformAlarmC*/TransformAlarmC__0____nesc_unnamed4323 {
...
enum /*TimerMilliP.AlarmToTimerC*/AlarmToTimerC__0____nesc_unnamed4324 {
#line 74
...
uint8_t arg_0x40952548);
#line 71
enum /*TimerMilliP.VirtualizeTimerC*/VirtualizeTimerC__0____nesc_unnamed4325 {
#line 71
...
#line 53
enum /*TimerMilliP.VirtualizeTimerC*/VirtualizeTimerC__0____nesc_unnamed4326 {
...
#line 59
typedef struct /*TimerMilliP.VirtualizeTimerC*/VirtualizeTimerC__0____nesc_unnamed4327 {
...
#line 78
# 149 "/opt/tinyos/tos/platforms/ucmini/Leds.nc"
...
#line 40
# 122 "/opt/tinyos/tos/platforms/ucmini/LedsP.nc"
static inline void LedsP__Leds__led3On(void )
#line 122
{
  LedsP__Led3__set();
...
#line 41
# 127 "/opt/tinyos/tos/platforms/ucmini/LedsP.nc"
static inline void LedsP__Leds__led3Off(void )
#line 127
{
  LedsP__Led3__clr();
...
# 83 "/opt/tinyos/tos/lib/timer/Timer.nc"
inline static void /*TimerMilliP.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40952548){
#line 83
  switch (arg_0x40952548) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*TimerMilliP.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40952548);
#line 83
      break;
#line 83
    }
...
#line 64
  /*TimerMilliP.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startPeriodic(5U, dt);
#line 64
}
#line 64
# 293 "ESP8266P.nc"
...
# 3 "ESP8266.nc"
inline static uint8_t UerC__ESP8266__mode(uint8_t val){
#line 3
  unsigned char __nesc_result;
#line 3
...
#line 110
    /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__default__sendDone(arg_0x40549e00, msg, error);
#line 110
}
#line 110
...
# 2 "ESP8266.nc"
inline static uint8_t UerC__ESP8266__init(void ){
#line 2
  unsigned char __nesc_result;
#line 2
...
# 157 "/opt/tinyos/tos/platforms/ucmini/LedsP.nc"
static void LedsP__Leds__set(uint8_t val)
#line 157
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
